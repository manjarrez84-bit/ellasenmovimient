      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-primary mb-8 text-balance">Detalles de Nuestros Programas</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left max-w-4xl mx-auto">
              <div className="bg-card p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-primary mb-3 text-balance">Asesoría Legal Integral</h3>
              ...
              <div className="bg-card p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-primary mb-3 text-balance">Apoyo Psicológico y Emocional</h3>
                <p className="text-foreground text-balance">
              ...
              <div className="bg-card p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-primary mb-3 text-balance">Talleres de Capacitación Laboral</h3>
                <p className="text-foreground text-balance">
              ...
              <div className="bg-card p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-primary mb-3 text-balance">Educación para el Empoderamiento</h3>
                <p className="text-foreground text-balance">
